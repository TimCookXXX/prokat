...
//
// Список — таблица со шторкой: строки плотные, как объявления в кабинете, а
// заявка целиком (телефон, комментарий, кнопки решения) открывается по клику.
// Закрытые лежат в той же таблице приглушёнными и позади живых.
...
export default async function CabinetRequestsPage({
  ...
  searchParams: Promise<{ role?: string | string[]; request?: string | string[] }>;
}) {
