...
export const content = {
  site: {
    ...
    description:
      "Цены и условия прокатов города в одном месте: итог за ваши даты с доставкой, залог и дата проверки каждой цены.",
  ...
  home: {
    ...
    heroSubtitle: "Итог за ваши даты с доставкой — у всех прокатов города",
    // Главная сравнения (макет HomeB).
    compareTitle: "Возьмите напрокат дешевле",
    compareSubtitle: (cityIn: string) => `Сравниваем прокаты ${cityIn}: итог за ваши даты, доставка и залог — сразу`,
    ...
    trustItems: [
      ...
      { title: "Итог, а не цена за сутки", text: "Минимальный срок, недельный тариф и доставка — уже в сумме." },
    ...
    whyItems: [
      { title: "Итог, а не цена за сутки", text: "Считаем аренду за ваши даты с минимальным сроком и недельным тарифом, плюс доставку. Залог показываем отдельно." },
